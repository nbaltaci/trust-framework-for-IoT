...
* <b>IssuesWithPreviousNormalizationMethods.ipynb:</b> We explain attribute normalization methods that are previously proposed in seminal works of MADM [[1]](#1) [[2]](#2). We discuss the issues that we detect in using these methods in the context of trust computations for IoT. We explain those isues in detail and present sample scenarios where they can be observed.
